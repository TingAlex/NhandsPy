...
//            final GoodsInMainAdapter.ViewHolder holder = new GoodsInMainAdapter.ViewHolder(view);
    ...
    private void updateGoods() {
        new Thread(new Runnable() {
            @Override
            public void run() {
                BmobQuery<Users> innerQuery=new BmobQuery<>();
                ...
                bmobQuery.addWhereMatchesQuery("likes","Users",innerQuery);
                ...
                bmobQuery.findObjects(new FindListener<Good>() {
                    ...
                    public void done(List<Good> objects, BmobException e) {
                        if (objects != null) {
                            ...
                            Log.i("bmob", "done: query likes good finish!"+objects.get(0).getLikes());
